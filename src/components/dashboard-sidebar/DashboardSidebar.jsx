    ...
    <>
      {!isMobileNavVisible && (
        <div className='bg-white shadow-sm right-0 z-30 flex items-center justify-between lg:hidden'>
          ...
          <Link to="/admin/pages">
            <h1 className='font-montserrat text-text-main_green text-[22px] pr-4 cursor-pointer'>STARTUP SEED</h1>
          </Link>
        </div>
      )}
      <div className={`bg-white shadow-lg z-20 transition-all duration-300 ease-in-out ${isMobileNavVisible ? 'block' : 'hidden'} lg:block`}>
        ...
        <div className='flex flex-col items-center justify-center w-full gap-4 mt-6 lg:mt-16 cursor-pointer px-4' onClick={onExitHandlerr}>
          <span
            className='mt-auto bg-custom-gray w-full justify-center hover:bg-gray-500 text-white py-4 px-8 rounded-lg flex items-center'
          >
