    ...
    <>
      ...
      >
          ...
          <div className="w-full px-3 mb-6 md:mb-0 col-span-1">
            <div className="mb-4">
              ...
              <input
                ...
                className={`bg-gray-50 text-gray-900 text-sm rounded-lg outline-none border focus:ring-blue-500 focus:border-blue-500 block w-full p-3 ${
                  errors.firstname ? "border-red-700" : "border-gray-50"
                }`}
          ...
          <div className="w-full px-3 mb-6 md:mb-0 col-span-1">
            <div className="mb-4">
              ...
              <input
                ...
                className={`bg-gray-50 text-gray-900 text-sm rounded-lg outline-none border focus:ring-blue-500 focus:border-blue-500 block w-full p-3 ${
                  errors.lastname ? "border-red-700" : "border-gray-50"
                }`}
          ...
          <div className="w-full px-3 mb-6 md:mb-0 col-span-1">
            <div className="mb-4">
              ...
              <input
                ...
                className={`bg-custom-light rounded w-full p-3 text-gray-700 leading-tight border outline-none ${
                  errors.country ? "border-red-700" : "border-custom-light"
                }`}
                maxLength={250}
          ...
          <div className="w-full px-3 mb-6 md:mb-0 col-span-1">
            <div className="mb-4">
              ...
              <input
                ...
                className={`bg-custom-light rounded w-full p-3 text-gray-700 leading-tight border outline-none ${
                  errors.city ? "border-red-700" : "border-custom-light"
                }`}
                maxLength={250}
        ...
        <div className="flex items-center justify-end">
          <button
            type="submit"
            className={`bg-text-main_green border text-white border-text-main_green w-full lg:w-auto hover:bg-main-green hover:text-white font-gilroy-bold py-3 px-6 rounded focus:outline-none text-[13px] focus:shadow-outline ${
