              ...
              <pre key={Math.random().toString()}>
                ...
                >
                  <AccordionHeader
                    ...
                    className="text-[16px] p-2 font-normal bg-custom-gray text-white rounded-md hover:text-white"
                  >
...
const mapDispatchToProps = (dispatch) => {
  return {
    onGetProfessioanalInformation: (value) =>
      dispatch(getProfessioanalInformation(value)),
  };
};
