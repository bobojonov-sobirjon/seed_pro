...
function OneProjectView(props) {
    ...
    const replyHandler = async value => {
        ...
        try {
            ...
            getToastError(error?.response?.data?.error || "На сервере произошла ошибка.");
        }
    }
console.log(state)
    return (
            ...
            <div className='max-w-5xl mx-auto my-10'>
                ...
                <div className='flex items-center justify-between relative'>
                    <div className='flex flex-1 items-center'>
                        <div
                            className='bg-white p-2 lg:p-4 py-6 w-full shadow rounded-lg mb-4 min-h-[100px] flex items-center' >
                            <div className='flex items-center justify-center h-[80px] w-[80px] rounded-full text-white mr-4 border'>
                                <img src={state ? state.project_image : ""} alt='no image' className='w-hull h-full rounded-full' />
                            </div>
                ...
                <div className='my-14 flex flex-col gap-2'>
                    ...
                    Список команды
                     ...
                     <UserCard team={state?.group_emp_list}/>
                     </div>
                </div>
                <div className='my-14 flex flex-col gap-2'>
                    <h2 className='text-xl lg:text-2xl text-custom-gray font-gunterz lg:text-left'>
                ...
                <div className='my-14 flex flex-col gap-2'>
                    ...
                    отклик на проект
                     ...
                     <div className='flex flex-col gap-4 mt-4'>
                     <UserCard team={state?.reply_to_project}/>
                     </div>
                </div>
            </div>
