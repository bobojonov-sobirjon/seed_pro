...
function AllProjectsData(props) {
  ...
  const navigateHandler = (item) => {
    navigate(`/admin/all-projects/project-about/${item.id}`);
  };
      ...
      {data.results?.length > 0 ? (
          ...
          return (
            ...
            >
              <div className="flex flex-1 items-center">
                ...
                >
                  <div className="flex items-center justify-center h-[60px] lg:h-[80px] w-[60px] lg:w-[80px] text-white mr-3 lg:mr-4 rounded-full overflow-hidden">
                    <img
              ...
              <div className="flex-1 absolute top-[30%] right-4">
                {item.favorite ? (
                  ...
                  <IoStarOutline
                    className="text-xl md:text-3xl text-gray-500 cursor-pointer"
        ...
        <div className="flex justify-center mt-4">
          <span className="text-gray-500">
            {t("extraComponents.allProjectsData.not_found")}
          </span>
        </div>
      )}
