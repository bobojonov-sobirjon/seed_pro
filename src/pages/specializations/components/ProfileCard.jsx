                ...
                <div className="text-[#939393] text-[13px] lg:text-[14px]">
                  {user?.is_replyed ? (
                    <span className="flex items-center gap-2">
                      ...
                      <div className="animate-pulse w-3 h-3 lg:w-4 lg:h-4 rounded-full bg-red-700"></div>
                    </span>
                  ) : (
                    <span className="flex items-center gap-2">
                      {t(
                      ...
                      <div className="animate-pulse w-3 h-3 lg:w-4 lg:h-4 rounded-full bg-green-700"></div>
                    </span>
                  )}
                </div>
              ) : (
      ...
      <div className="flex px-2 items-center mt-4 flex-wrap font-gilroy_medium text-[14px] lg:text-[15px]">
        <div className="flex lg:flex-row flex-col lg:gap-12 gap-4 justify-between">
          <div className="text-custom-gray flex gap-3">
            ...
            <span className="">
              {user && user.sex == 1
                ? t("dashboard.header.specialists.details.profileCard.man")
                : "Женский"}
            </span>
          </div>
